...
#ifdef ESP_PLATFORM
    save_stream = doom_fopen(savename, "rb");
#else
...
#ifdef ESP_PLATFORM
    save_stream = doom_fopen(temp_savegame_file, "wb");
#else
...
#ifdef ESP_PLATFORM
        save_stream = doom_fopen(recovery_savegame_file, "wb");
#else
...
#ifdef ESP_PLATFORM
    if (vanilla_savegame_limit && doom_ftell(save_stream) > SAVEGAMESIZE)
#else
...
#ifdef ESP_PLATFORM
    doom_fremove(savegame_file);
    doom_frename(temp_savegame_file, savegame_file);
#else
