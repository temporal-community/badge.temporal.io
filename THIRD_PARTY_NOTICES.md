...
`docs/assets/photos/replay-badge-table.jpg` is a public documentation photo
provided for this repository. It is not source code and is not covered by this
